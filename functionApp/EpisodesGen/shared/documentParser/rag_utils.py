...
def save_doc_db(dataset_name="documents", page_content_column="context"):
    ...
    if dataset_name == "documents":
        docs = []
        for filename in os.listdir(os.path.join(os.getcwd(),"shared","documentParser",dataset_name)):
            if filename.endswith('.pdf'):
                text = extract_text_from_pdf(os.path.join(os.getcwd(),"shared","documentParser",dataset_name, filename))
                docs.append(text)
            elif filename.endswith('.txt'):
                text = extract_text_from_txt(os.path.join(os.getcwd(),"shared","documentParser",dataset_name, filename))
                docs.append(text)
